...
void Mur::setVertices(){
    ...
    case ANGLE_T2:{
        ...
        case SW:{
            Vertex NE_BOT(x_ + longueur_ - epaisseur_, 0, y_ + longueur_ - epaisseur_), NW_BOT(x_, 0, y_ + longueur_ - epaisseur_), SW_BOT(x_, 0, y_ + longueur_), SE_BOT(x_ + longueur_, 0, y_ + longueur_);
            Vertex NE_TOP(x_ + longueur_ - epaisseur_, hauteur_, y_ + longueur_ - epaisseur_), NW_TOP(x_, hauteur_, y_ + longueur_ - epaisseur_), SW_TOP(x_, hauteur_, y_ + longueur_), SE_TOP(x_ + longueur_, hauteur_, y_ + longueur_);
            vertices_.push_back({NE_TOP, NW_TOP, SW_TOP, SE_TOP});
            vertices_.push_back({NE_BOT, NW_BOT, SW_BOT, SE_BOT});
            vertices_.push_back({NE_TOP, NW_TOP, NW_BOT, NE_BOT});
            vertices_.push_back({NW_TOP, SW_TOP, SW_BOT, NW_BOT});
